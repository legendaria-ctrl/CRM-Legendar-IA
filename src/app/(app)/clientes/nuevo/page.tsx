      ...
      const id = await crearCliente({
        ...
        estadoInicial:
          sesion.rol === ROLES.VENDEDOR
            ? ESTADOS_CLIENTE.PENDIENTE_AUTORIZACION
            : ESTADOS_CLIENTE.NUEVO,
      });
    ...
    <div className="mx-auto flex max-w-xl flex-col gap-6">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-sm text-muted">
          {sesion?.rol === ROLES.VENDEDOR
            ? "Quedará pendiente de autorización: un administrador lo revisará antes de enviarle la invitación."
        ...
        <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
          ...
          <div className="animate-fade-in relative flex w-full max-w-md flex-col gap-3 rounded-[2rem] bg-surface p-6 shadow-2xl">
            ...
            <p className="text-sm text-foreground">
              ...
              . No se creó el nuevo registro para evitar duplicarlo.
            </p>
